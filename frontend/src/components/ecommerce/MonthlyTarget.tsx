  ...
  const options = useMemo<ApexOptions>(() => ({
    ...
    plotOptions: {
      radialBar: {
        ...
        track: {
          background: isDarkMode ? 'rgba(255, 255, 255, 0.1)' : chartColors.gray[200],
          strokeWidth: "100%",
          margin: 5,
          dropShadow: {
            enabled: true,
        ...
        dataLabels: {
          ...
          value: {
            ...
            fontFamily: "Poppins, sans-serif",
            offsetY: -40,
            color: isDarkMode ? 'rgba(255, 255, 255, 0.9)' : chartColors.gray[900],
    ...
    fill: {
      ...
      gradient: {
        ...
        type: 'horizontal',
        shadeIntensity: 0.5,
        gradientToColors: [chartColors.accent[500]],
        stops: [0, 100],
      },
    },
    stroke: {
        ...
        <ChartWrapper animation="scale">
          <div className="relative">
            ...
            <div
              ...
              style={{
                background: `radial-gradient(circle, ${chartColors.primary[500]}15 0%, transparent 70%)`,
              }}
            />
