  ...
  return (
    <div className="glass-card overflow-hidden rounded-2xl">
      ...
      >
        ...
        <button
          className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-gray-100 duration-200 transition-transform ease-linear dark:bg-white/[0.03] ${
            isOpen
