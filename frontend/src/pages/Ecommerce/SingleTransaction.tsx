...
export default function SingleTransaction() {
  return (
    <>
      <PageMeta
        title="React.js E-commerce Single Transaction  | Unity Financial Network"
        description="This is React.js E-commerce Single Transaction  page for Unity Financial Network"
      />
